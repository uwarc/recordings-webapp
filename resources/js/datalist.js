    ...
    return this.each(function() {
      ...
      datalistItems.each(function() {
        temp_item = $("<li />", {
          ...
          "html": "<span class='value'>" + $(this).val() + "</span><span class='description'>" + $(this).text() + "</span>"
        });
        temp_item.attr("value", $(this).val());
        temp_items.appendChild(temp_item[0]);
      });
      ...
      $input.on("keydown", function(e) {
        ...
        if ( e.keyCode == 13 || e.keyCode == 9 ){
          if (active.length) {
            ...
            $input.trigger('input');
            item_selected(active.attr('value'));
          }
          $datalist.fadeOut(options.fadeOutSpeed);
          datalistItems.removeClass("active");
        }
